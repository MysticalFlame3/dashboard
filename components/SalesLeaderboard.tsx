            ...
            <div className="bg-gradient-to-b from-[#FFF0F5] to-[#FFF5F7] rounded-[2.5rem] p-6 flex-1 flex flex-col gap-6 relative">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-wrap gap-2 pl-4">
                        <div className="bg-white px-3 py-1.5 rounded-full shadow-pill flex items-center gap-1.5 hover:shadow-md transition-shadow cursor-pointer border border-border-subtle">
                ...
                <div className="mt-2">
                    ...
                    <div className="grid grid-cols-12 gap-3 h-[180px]">
                        ...
                        <div className="col-span-7 grid grid-rows-3 gap-3">
                            ...
                            {/* Other (Bottom Wide) */}
                            <div className="row-span-1 bg-white px-4 py-2 rounded-[1.2rem] shadow-card-primary border border-border-subtle flex items-center justify-between">
                                <div className="flex items-center gap-2">
