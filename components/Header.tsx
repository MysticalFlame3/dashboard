    ...
    <div className="flex flex-col gap-6 mb-8">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="relative w-full max-w-md">
          ...
          <input 
            ...
            className="w-full bg-white rounded-full py-3.5 pl-12 pr-4 text-[13px] font-medium text-gray-700 placeholder:text-gray-300 focus:outline-none shadow-[0_2px_10px_-2px_rgba(0,0,0,0.05)] focus:shadow-md transition-shadow"
          />
        </div>
        ...
        <div className="flex items-center gap-4">
             {/* Profile Toggle Pill */}
             <div className="bg-white rounded-full p-1 pl-4 pr-1 flex items-center gap-4 shadow-sm cursor-pointer hover:shadow-md transition-shadow h-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mt-2">
        ...
        <div className="flex flex-wrap items-center gap-2">
            {/* Add Member Button */}
            <button className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm text-gray-400 hover:text-gray-600 border border-transparent hover:border-gray-200 transition-all">
                <Plus size={20} />
            </button>
            ...
            {[
                ...
                <div key={idx} className="flex items-center gap-2 bg-white pl-1 pr-4 py-1 rounded-full shadow-sm cursor-pointer hover:shadow-md transition-shadow border border-transparent">
